...
```{r prep, echo=TRUE, results='hide',warning=FALSE, message=FALSE}
...
```{r q1a, echo=TRUE, warning=FALSE, message=FALSE}
# Q1 --------------------------------------------------------------
...
```{r q1c, echo=TRUE, messages=FALSE, warning=FALSE}
...
```{r rbco, echo=TRUE, warning=FALSE, message=FALSE}
# FUNCTION
